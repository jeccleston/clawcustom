...
Deploy nanobot on [Coolify](https://coolify.io) - self-hosted Vercel/Netlify alternative.
...
| `AI_MODEL` | LLM model | `anthropic/claude-opus-4-5` |
| `AI_PROVIDER` | Provider (auto, openrouter, anthropic) | `auto` |
...
📖 **Full guide**: See [`COOLIFY_DEPLOY.md`](COOLIFY_DEPLOY.md) for detailed instructions.
