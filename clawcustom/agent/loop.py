...
from .tools.stock import StockAnalysisTool, MarketOverviewTool, CompareStocksTool
from .tools.web import WebFetchTool, WebSearchTool
from .worker import WorkerAgentManager
...
if TYPE_CHECKING:
    from .schema import ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        try:
            ...
            self.tools.register(CompareStocksTool())
            logger.info("Stock analysis tools enabled")
        except Exception as e:
            logger.debug(f"Stock tools not available: {e}")
