...
class PluginLoader:
    ...
    async def load_plugin(self, name: str) -> BasePlugin:
        ...
        try:
            module = importlib.import_module(f"nanobot.plugins.{name}")
    ...
    async def reload_plugin(self, name: str) -> BasePlugin:
        ...
        # Clear module cache
        if f"nanobot.plugins.{name}" in importlib.sys.modules:
            del importlib.sys.modules[f"nanobot.plugins.{name}"]
